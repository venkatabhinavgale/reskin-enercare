...
if (!empty($_GET['pwd']) && $_GET['pwd'] == 'en3rc@reADMINz0nly') {
  ...
  foreach ($form_entry_urls as $form_id => $entry_url) {
    ...
    /*
    $filename_environment = "Development";
    if (isset($_SERVER['HTTP_HOST']) && strpos($_SERVER['HTTP_HOST'], 'www.enercare.com') !== false) {
    ...
    if (isset($_GET['upload'])) {
      ...
      if ($clearlink_ssh_conn) {
        ...
        if (isset($_SERVER['HTTP_HOST']) && strpos($_SERVER['HTTP_HOST'], 'localhost') !== false) {
          $pubkey = 'C:/portent-ssh-keys/enercare/ecwebforms.pub';
          $privkey = 'C:/portent-ssh-keys/enercare/ecwebforms';
        } elseif (isset($_SERVER['HTTP_HOST']) && strpos($_SERVER['HTTP_HOST'], 'dev.enercare.ca') !== false) {
          $pubkey = '/mnt/gfs/enercare2019.dev/nobackup/sshkeys/ecwebforms.pub';
          $privkey = '/mnt/gfs/enercare2019.dev/nobackup/sshkeys/ecwebforms';
        } else {
          $pubkey = '/mnt/gfs/enercare2019.prod/nobackup/sshkeys/ecwebforms.pub';
          $privkey = '/mnt/gfs/enercare2019.prod/nobackup/sshkeys/ecwebforms';
        }
        */
