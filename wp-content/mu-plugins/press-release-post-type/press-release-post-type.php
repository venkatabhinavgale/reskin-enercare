 ...
 *
 * @wordpress-plugin
 * Plugin Name: Press Release Post Type
 * Plugin URI:  http://github.com/devinsays/team-post-type
 * Description: Enables a press release post type, taxonomy and metaboxes.
 * Version:     0.1.0
 * Author:      Portent
 * Author URI:  http://github.com/devinsays/team-post-type
 * Text Domain: press-release-post-type
 * License:     GPL-2.0+
...
$post_type_registrations = new Press_Release_Post_Type_Registrations;

// Instantiate main plugin file, so activation callback does not need to be static.
$post_type = new Press_Release_Post_Type( $post_type_registrations );
...
//$post_type_metaboxes = new Press_Release_Post_Type_Metaboxes;
...
if ( is_admin() ) {
	...
	$post_type_admin = new Press_Release_Post_Type_Admin( $post_type_registrations );
