 ...
 * @package Campaign_Post_Type
 */
class Campaign_Post_Type_Metaboxes {

	public function init() {
		add_action( 'add_meta_boxes', array( $this, 'campaign_meta_boxes' ) );
		add_action( 'save_post', array( $this, 'save_meta_boxes' ),  10, 2 );
	}

	/**
	 * Register the metaboxes to be used for the campaign post type
	 *
	 * @since 0.1.0
	 */
	...
	*/
	function render_meta_boxes( $post ) {
		...
		<table class="form-table">
			...
			<tr>
				<td class="campaign_meta_box_td" colspan="2">
					<label for="profile_title"><?php _e( 'Title', 'campaign-post-type' ); ?>
					</label>
				</td>
				<td colspan="4">
					<input type="text" name="profile_title" class="regular-text" value="<?php echo $title; ?>">
					<p class="description"><?php _e( 'E.g. CEO, Sales Lead, Designer', 'campaign-post-type' ); ?></p>
				</td>
			</tr>

			<tr>
				<td class="campaign_meta_box_td" colspan="2">
					<label for="profile_linkedin"><?php _e( 'LinkedIn URL', 'campaign-post-type' ); ?>
					</label>
				</td>
				<td colspan="4">
			...
			<tr>
				<td class="campaign_meta_box_td" colspan="2">
					<label for="profile_twitter"><?php _e( 'Twitter URL', 'campaign-post-type' ); ?>
					</label>
				</td>
				<td colspan="4">
			...
			<tr>
				<td class="campaign_meta_box_td" colspan="2">
					<label for="profile_facebook"><?php _e( 'Facebook URL', 'campaign-post-type' ); ?>
					</label>
				</td>
				<td colspan="4">
