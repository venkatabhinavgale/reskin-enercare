...
$post_type_registrations = new FAQ_Post_Type_Registrations;

// Instantiate main plugin file, so activation callback does not need to be static.
$post_type = new FAQ_Post_Type( $post_type_registrations );
...
//$post_type_metaboxes = new FAQ_Post_Type_Metaboxes;
...
if ( is_admin() ) {
	...
	$post_type_admin = new FAQ_Post_Type_Admin( $post_type_registrations );
