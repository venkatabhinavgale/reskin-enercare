      ...
      $cl_phone = " cl-phone";
		...
		if(get_field('mobile_cta_type') === 'split-a-p') {
			...
			echo '<div data-interface="floating-cta" class="floating-cta floating-cta--split-a-p is-style-shadowed">';
				...
				echo '<a style="border-radius: 0;" class="wp-block-button__link has-red-background-color has-background' . $cl_phone . '" href="' . $footer_link['url'] . '"><img loading="lazy" class="wp-image-7350" style="width: 24px;" src="https://www.enercare.ca/wp-content/uploads/2021/10/call-24px-w.svg" alt="" width="24" height="24">' . $footer_link['title'] .'</a>';
			echo '</div>';
		} else {
