...
function enercare_site_footer() {
	echo '<div class="footer-left">';
		...
		echo '<p class="footer-links"><a href="/sites/default/files/2020-04/Privacy-Policy.pdf">Privacy Policy</a> <a href="' . home_url( 'legal/terms-of-use' ) . '">Terms of Use</a> <a href="#">ECRA/ESA License #7010500</a></p>';
	echo '</div>';
