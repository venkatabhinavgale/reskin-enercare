...
<div class="<?php echo esc_attr($classes); ?>" data-allow-multiple>
    ...
    <?php } ?>
    <h2 class="block-offer-card__heading <?= !empty($block['fontSize']) ? 'is-font-size-'.$block['fontSize'] : ''; ?>"><?= $campaign_heading; ?></h2>
