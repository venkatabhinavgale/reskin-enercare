...
<div class="<?php echo esc_attr($classes); ?>" data-allow-multiple>
    ...
    <div class="block-offer-card__container">
        ...
        <?php if ($campaign_expiration && $campaign_expiration != "" && !$show_hide_expiration_date) { ?><p class="block-offer-card__offer-expiration">Offer expires <?= date('F d, Y', strtotime($campaign_expiration)); ?>.<?php } ?></p>
