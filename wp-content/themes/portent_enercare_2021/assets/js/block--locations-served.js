...
Array.prototype.slice.call(document.querySelectorAll('.block-locations-served__locations')).forEach(function (accordion) {
  ...
  var triggers = Array.prototype.slice.call(accordion.querySelectorAll('.block-locations-served__trigger'));
  var panels = Array.prototype.slice.call(accordion.querySelectorAll('.Accordion-panel'));
  accordion.addEventListener('click', function (event) {
    var target = event.target;

    if (target.classList.contains('block-locations-served__trigger')) {
      ...
      if (!isExpanded) {
        ...
        accordion.parentElement.setAttribute('data-open', true); // If toggling is not allowed, set disabled state on trigger
  ...
  accordion.querySelectorAll('.block-locations-served__trigger').forEach(function (trigger) {
