...
const projectURL = 'enercare.test';
...
const watchJsCustom = './assets/js/src/*.js';
...
const bugReport = 'https://portent.com';

// Last translator Email ID.
const lastTranslator = 'Portent Interactive developers@portent.com';

// Team's Email ID.
const team = 'Development developers@portent.com';
