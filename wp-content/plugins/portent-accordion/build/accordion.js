...
const Accordion = () => {
  ...
  const accordionToggles = document.querySelectorAll(".portent-accordion__toggle"); //grab all accordion content

  const accordionContents = document.querySelectorAll(".portent-accordion__content"); //mobile check
