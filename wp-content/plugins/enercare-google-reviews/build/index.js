(window["webpackJsonp_ecreviews_block"] = window["webpackJsonp_ecreviews_block"] || []).push([["style-index"],{
...
/******/
/******/ 	var jsonpArray = window["webpackJsonp_ecreviews_block"] = window["webpackJsonp_ecreviews_block"] || [];
...
function Edit(props) {
  ...
  withSelect(function (select, props) {
    var query = {
      ...
      orderby: 'title',
      order: 'asc',
      status: 'publish' //categories : [ 5, 10, 15 ], // category ID or IDs
      //tags : 4, // tag ID, you can pass multiple too [ 4, 7 ]
      //search : 'search query',

    };
    return {
      locations: select('core').getEntityRecords('postType', 'gmb_location', query) //metaValue: select( 'core/editor' ).getEditedPostAttribute( 'meta' )[ props.metaKey ],
    ...
    return el(SelectControl, {
      ...
      onChange: function (content) {
        setAttributes({
          locationId: parseInt(content)
        }); //props.setMetaValue( content );
      },
      value: attributes.locationId
    });
  });
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(PostsDropdownControl, {
    value: attributes.locationId
